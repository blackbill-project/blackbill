Contributing to Blackbill Core
==================================

The Blackbill Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Blackbill Core project, and is not to be
confused with overall Blackbill Network Protocol consensus changes.

Whether a pull request is merged into Blackbill Core rests with the project merge
...
Patches that change Blackbill consensus rules are considerably more involved than
...
Where a patch set proposes to change the Blackbill consensus, it must have been
...
The project leader is the release manager for each Blackbill Core release.
