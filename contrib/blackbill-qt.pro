...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/blackbill-cli.cpp \
           src/blackbill-tx.cpp \
           src/blackbill.cpp \
           src/db.cpp \
           ...
           src/qt/blackbill.cpp \
           src/qt/blackbillstrings.cpp \
...
RESOURCES += src/qt/blackbill.qrc src/qt/blackbill_locale.qrc

TRANSLATIONS += src/qt/locale/blackbill_bg.ts \
                src/qt/locale/blackbill_de.ts \
                src/qt/locale/blackbill_en.ts \
                src/qt/locale/blackbill_es.ts \
                src/qt/locale/blackbill_fi.ts \
                src/qt/locale/blackbill_fr.ts \
                src/qt/locale/blackbill_it.ts \
                src/qt/locale/blackbill_ja.ts \
                src/qt/locale/blackbill_pl.ts \
                src/qt/locale/blackbill_pt.ts \
                src/qt/locale/blackbill_ru.ts \
                src/qt/locale/blackbill_sk.ts \
                src/qt/locale/blackbill_sv.ts \
                src/qt/locale/blackbill_vi.ts \
                src/qt/locale/blackbill_zh_CN.ts \
                src/qt/locale/blackbill_zh_TW.ts
