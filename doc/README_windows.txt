...
Intro
-----
Blackbill (BIL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Blackbill utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run blackbill-qt.exe.

Blackbill Core is the original Blackbill client and it builds the backbone of the network.
However, it downloads and stores the entire history of Blackbill transactions;
