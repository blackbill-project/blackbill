...
In order to support loading of multiple wallets in blackbill-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blackbill.cpp.
...
Changes to blackbill.cpp
----------------------
blackbill.cpp is the entry point into blackbill-qt, and as such, will require some minor modifications to provide hooks for
