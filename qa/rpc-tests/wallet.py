...
#   c) node1 mines 32 blocks, so now node 0 has 500000BIL, node 1 has 4250BIL, node2 has none.
#   d) node0 sends 601 BIL to node2, in two transactions (301 BIL, then 300 BIL).
