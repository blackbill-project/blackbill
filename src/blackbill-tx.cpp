...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Blackbill Core blackbill-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blackbill-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blackbill transaction") + "\n" +
                               "  blackbill-tx [options] -create [commands]   " + _("Create hex-encoded blackbill transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blackbill transaction
