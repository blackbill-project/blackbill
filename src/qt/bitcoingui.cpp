                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Blackbill Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BIL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blackbill: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Blackbill Core"), this);
    aboutAction->setStatusTip(tr("Show information about Blackbill Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Blackbill"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BIL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BIL addresses"));
    ...
    openAction->setStatusTip(tr("Open a blackbill: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Blackbill Core help message to get a list with possible Blackbill command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Blackbill Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Blackbill network", "", count));
}
...
{
    QString strTitle = tr("Blackbill Core"); // default title
