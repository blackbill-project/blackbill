...
/** Utility functions used by the Blackbill Qt UI.
 */
namespace GUIUtil
{
...
// Render BIL addresses in monospace font
...
// Parse "blackbill:" URI into recipient object, return true on successful parsing
