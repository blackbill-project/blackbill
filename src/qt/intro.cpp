...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Blackbill Core"),
     ...
     * override -datadir in the blackbill.conf file in the default data directory
     * (to be consistent with blackbilld behavior)
     */
    if (dataDir != getDefaultDataDirectory())
