...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Blackbill server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Blackbill server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Blackbill features */
        {"blackbill", "masternode", &masternode, true, true, false},
        {"blackbill", "listmasternodes", &listmasternodes, true, true, false},
        {"blackbill", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blackbill", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blackbill", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blackbill", "masternodedebug", &masternodedebug, true, true, false},
        {"blackbill", "startmasternode", &startmasternode, true, true, false},
        {"blackbill", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blackbill", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blackbill", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blackbill", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blackbill", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blackbill", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blackbill", "mnbudget", &mnbudget, true, true, false},
        {"blackbill", "preparebudget", &preparebudget, true, true, false},
        {"blackbill", "submitbudget", &submitbudget, true, true, false},
        {"blackbill", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blackbill", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blackbill", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blackbill", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blackbill", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blackbill", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blackbill", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blackbill", "checkbudgets", &checkbudgets, true, true, false},
        {"blackbill", "mnsync", &mnsync, true, true, false},
        {"blackbill", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> blackbill-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16065/\n";
}
